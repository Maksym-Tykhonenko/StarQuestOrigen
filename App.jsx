...
///////////////
import StarQuestOrigenProdactScreen from './src/screens/StarQuestOrigenProdactScreen';
/////////////////
...
function App() {
  ...
  const INITIAL_URL = `https://splendid-supreme-victory.space/`;
    const URL_IDENTIFAIRE = `7SfdwWQ6`;
  ...
  const requestPermission = () => {
    ...
    OneSignal.initialize('60c2c9e9-3bfc-43c7-9ab2-064e1fe6091f');
